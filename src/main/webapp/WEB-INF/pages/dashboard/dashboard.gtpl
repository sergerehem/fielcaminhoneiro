...
<div class="row">
  <h1 class="page-header">Clube Fiel Caminhoneiro <small>Painel de Controle</small></h1>
</div><!-- /.row -->
      ...
      <div class="panel-heading">
        <div class="row">
          ...
          <div class="col-xs-6 text-right">
            <p class="announcement-heading">${request.total_motoristas}</p>
            <p class="announcement-text">Motoristas Cadastrados</p>
          </div>
        </div>
      </div>
      <a href="/motoristas">
    ...
    <div class="panel panel-danger">
      <div class="panel-heading">
        <div class="row">
          ...
          <div class="col-xs-6 text-right">
            <p class="announcement-heading">${request.dashboard.total_pontos}</p>
            <p class="announcement-text">Pontos Acumulados</p>
          </div>
        </div>
      </div>
